        ...
        <div class="row bg-white shadow-sm rounded-3 py-5 px-2" style="margin-top: 90px;">            
            ...
            <div class="order-1 order-md-2 col-md-6 col-sm-12 p-2 d-flex justify-content-center align-items-center">
                <div class="justify-content-center text-center">
                    ...
                    <div class="text-center mt-4 font-weight-light">
                        Já tem conta? <a href="<?php echo site_url('login'); ?>" class="text-primary">Login</a>
                    </div>
            ...
            <div class="order-2 order-md-1 col-md-6 col-sm-12 p-2 d-flex justify-content-center align-items-center " >
                <div class="d-block text-center">
                    ...
                    >
                    <h4>Já tenho</h4>
                    <a href="<?php echo site_url('login'); ?>" class="text-decoration-none text-primary">
                        <h4>Conta</h4>
                    </a>
                </div>
            </div>
